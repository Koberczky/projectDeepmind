...
function waitBuilding() {
    ...
    document.getElementById('navImage').innerHTML = "<div class='buildingDesc'>" + buildingInfo[buildingNum].description + "</div>";
    document.getElementById('buildingInfo').innerHTML = " <p id = 'enterBuilding'> <a href = 'javascript:void(0)' onclick = 'leaveBuilding()'> Click when you're ready to go to " + buildingInfo[buildingNum + 1].fullTitle + "</a></p>";
}
